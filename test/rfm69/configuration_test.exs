defmodule RFM69.ConfigurationTest do
  ...
  test "to_binary returns correct information" do
    ...
    {:ok, expected_bytes} =
      Base.decode16(
        "040807A10052E5266641000292F520245F091A40B07B9B884080408006100000000002FF80078000E40000001898FF00FF000101010100000000009400000000000000000000000000000000000100"
      )

    assert expected_bytes == Configuration.to_binary(test_configuration)
  end
end
